package edu.cmu.lti.oaqa.bio.retrieval.query.structure;
...
public class QueryComponent {
  ...
  public QueryComponent(KeytermInQuery query, List<String> synAll) {
    this.synonyms = new ArrayList<String>();
    if (synAll != null) this.synonyms.addAll(synAll);
    this.keyterm = query;
    this.isConcept = true;
  }
  ...
  public static String getSynonymsToString(String leftWrapper, String rightWrapper, List<String> synonyms) {
    String result = "";
    if (synonyms != null) {
   ...
   * 
   * @param a The string will be replaced
   * @param b The string will replace a
   */
