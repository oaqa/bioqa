...
public class ProteinProteinRelationKeywords {
    ...
    public ProteinProteinRelationKeywords() {
        ...
        String group1 = "activation accumulation elevation hasten incitation "
                        + "increase induce initiation promotion stimulation "
        ...
        for (String s : groupTerms) {
            if (s.trim().isEmpty())
                continue;
            group1List.add(cleaner.getStemmedTerm(s));
        }
        ...
        for (String s : groupTerms) {
            if (s.trim().isEmpty())
                continue;
            group2List.add(cleaner.getStemmedTerm(s));
        }
        ...
        for (String s : groupTerms) {
            if (s.trim().isEmpty())
                continue;
            group3List.add(cleaner.getStemmedTerm(s));
        }
        ...
        for (String s : groupTerms) {
            if (s.trim().isEmpty())
                continue;
            group4List.add(cleaner.getStemmedTerm(s));
        }
        ...
        for (String s : groupTerms) {
            if (s.trim().isEmpty())
                continue;
            group5List.add(cleaner.getStemmedTerm(s));
        }
        ...
        for (String s : groupTerms) {
            if (s.trim().isEmpty())
                continue;
            group6List.add(cleaner.getStemmedTerm(s));
        }
        ...
        for (String s : groupTerms) {
            if (s.trim().isEmpty())
                continue;
            group7List.add(cleaner.getStemmedTerm(s));
        }
        ...
        for (String s : groupTerms) {
            if (s.trim().isEmpty())
                continue;
            group8List.add(cleaner.getStemmedTerm(s));
        }
        ...
        for (String s : groupTerms) {
            if (s.trim().isEmpty())
                continue;
            group9List.add(cleaner.getStemmedTerm(s));
        }
        ...
        for (String s : groupTerms) {
            if (s.trim().isEmpty())
                continue;
            group10List.add(cleaner.getStemmedTerm(s));
        }
        ...
        for (String s : groupTerms) {
            if (s.trim().isEmpty())
                continue;
            group11List.add(cleaner.getStemmedTerm(s));
        }
        ...
        for (String s : groupTerms) {
            if (s.trim().isEmpty())
                continue;
            group12List.add(cleaner.getStemmedTerm(s));
        }
        ...
        for (String s : groupTerms) {
            if (s.trim().isEmpty())
                continue;
            group13List.add(cleaner.getStemmedTerm(s));
        }
        ...
        for (String s : groupTerms) {
            if (s.trim().isEmpty())
                continue;
            group14List.add(cleaner.getStemmedTerm(s));
        }
        ...
        for (String s : groupTerms) {
            if (s.trim().isEmpty())
                continue;
            group15List.add(cleaner.getStemmedTerm(s));
        }
        ...
        for (String s : groupTerms) {
            if (s.trim().isEmpty())
                continue;
            group16List.add(cleaner.getStemmedTerm(s));
        }
