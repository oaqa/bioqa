...
/**
 * BioNameLexicalVariants is the class to generate all the lexical variants for
 * a given biological name. The rules are inspired by <i>Zhou, W., Yu, C. T.,
 * Torvik, V. I., & Smalheiser N. R. (2006). A Concept-based Framework for
 * Passage Retrieval in Genomics. TREC 2006 Proceedings</i>.
 * 
...
public class BioNameLexicalVariants {
   ...
   * 
   * @param term The biological term.
  ...
  /**
   * Gets all the alphanumerical variants (including Roman format) for a given
   * term. For example, "Sec6" will get "Sec6", "Sec 6", "SecVI" and "Sec VI".
   * 
   * @param term The biological term.
   * @return a String list of all the lexical variants. <code>null</code> if the
  ...
  /**
   * Gets all the combinations by retrieving one entity from each list with the
   * order of the lists. For example, for [List1["11","12"], List2["21","22"],
   * List3["31","32"]], this method returns
  ...
  /**
   * Converts an Arabic numeral into a Roman numerical. But this method only
   * works for
   * 
   * @param n The Arabic numeral
