 ...
 * information of forming query. This class must accept a list of {@link Keyterm}, which has
...
public class QueryStrategy {
  ...
  public QueryStrategy(List<Keyterm> keyterm) {
    this.keyTerms = keyterm;
  }

  // set all the variables.
  public void setKeyterms(List<Keyterm> keyterm) {
    this.keyTerms = keyterm;
  }
  ...
  private void formQueryContainer() {
    ...
    // PART I: phrase part -- this part considers all the phrases in this list of Keyterm
    for (Keyterm keyterm : this.keyTerms) {

      if (keyterm.getType() == PHRASE_KEY_TERMS) {
    ...
    for (Keyterm keyterm : this.keyTerms) {
      ...
      if (keyterm.getType() == ORIGINAL_KEY_TERMS) {
   ...
   * Only for test
   */
  private void printKeytermContent(Keyterm keyterm) {
    // for the sake of information
    // System.out.println(keyterm.getTagBySource("LingPipeHmmPosTagger"));
    System.out.println("-------------------------" + keyterm.getText() + "   " + keyterm.getType()
